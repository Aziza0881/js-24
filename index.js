...
price: ${aa.price},
beaten: ${aa.beaten},
fuel_comsumption: ${aa.fuel_comsumption},
year: ${aa.year},
mileage: ${aa.mileage},
date: ${aa.tech_passport.date},
exp_date: ${aa.tech_passport.exp_date},
`)



let price2 = confirm ("Цена " + aa.price) 


let money = prompt("Сколько вы хотите заплатить?")

if (
    money - aa.price > 0 ){
        alert('Вот сдача: ' + (money - aa.price))
    }else if(money - aa.price == 0) {
        alert('Поздравляем с покупкой!')
    } else if (money - aa.price < 0) {
      alert('Не хватает: ' + (money - aa.price))  
    }
